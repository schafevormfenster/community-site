...
const CalendarMonthSection: FC<CalendarMonthSectionProps> = ({ month, children }) => {
  return (
    <section className="relative">
      <div className="absolute h-full w-8 bg-secondary ">
        <div className="sticky top-0 w-8 pt-20 mb-8">
          <i className="inline-block py-1 pl-1 w-8 text-vertical text-right transform rotate-180 text-white text-s not-italic">
